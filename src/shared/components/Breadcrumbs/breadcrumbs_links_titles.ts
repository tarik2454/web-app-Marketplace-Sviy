export type TlinksTitles = {
  link: string;
  title: string;
};

export const linksTitles: TlinksTitles[] = [
  { link: 'signin', title: 'Вхід в особистий кабінет' },
  ...
  { link: 'my-purchases', title: 'Замовлення' },
  { link: 'my-ads', title: 'Мої Оголошення' },
  { link: 'new-ad', title: 'Нове оголошення' },
  { link: 'reviews', title: 'Відгуки' },
  { link: 'my-sales', title: 'Замовлення моїх клієнтів' },
];
