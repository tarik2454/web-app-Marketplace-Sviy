  ...
  if (additionalText) {
    return (
      <div className="max-w-[400px] flex flex-col gap-5 mx-auto mb-10">
        <h1 className="text-neutral-800  text-center font-normal font-lato leading-10 md:text-2xl sm:text-xl">
          {heading}
        </h1>
    ...
    return (
      <div className="max-w-[400px] block mx-auto mb-10">
        <h1 className="text-neutral-800 text-2xl text-center font-normal font-lato leading-10 md:text-2xl sm:text-xl">
          {heading}
        </h1>
      </div>
    );
