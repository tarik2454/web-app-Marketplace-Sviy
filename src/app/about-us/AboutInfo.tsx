...
export default function AboutInfo() {
  return (
    <Section className="pt-11 pb-20 md:pt-[38px] md:pb-[104px] xl:pt-[98px] xl:pb-[164px]">
      <Container>
          <h2 className="text-xl mb-8 md:text-[32px] md:mb-16 xl:mb-[88px] xl:text-[40px]">Про нас</h2>
          <p className="mb-6 md:mb-0 md:text-xl xl:mb-6">
            <span className="text-blue-700">Свій</span> — інноваційний торговий
            майданчик, де можна продвати і купувати продукти місцевих
            виробників.
          </p>
          ...
          <p className='md:text-xl md:mb-6'>Ласкаво просимо в наш світ смаку та традицій!</p>
          <p className='md:text-xl'>
            ...
            сильні та різноманітні місцеві продовольчі системи, від яких
            отримають вигоду продовольчі центри, виробники, покупці та їдці.
          </p>
      </Container>
    </Section>
  );
