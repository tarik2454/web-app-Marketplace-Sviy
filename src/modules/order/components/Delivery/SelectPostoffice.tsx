...
// import options from '@/modules/catalogueProducts/data/options-data';
...
// const SelectItems = (props: any) => {
//   const [field, state, { setValue }] = useField(props.name);
//   const onChange = (
//     newValue: SingleValue<OptionType>,
//     _: ActionMeta<OptionType>
//   ) => {
//     setValue(newValue?.value); // Змінив функцію onChange
//   };
...
//     _: ActionMeta<OptionType>
//   ) => {
//     const cityValue = newValue?.value;
//     formik.setFieldValue('city', cityValue);
//     if (cityValue) {
//       const warehousesList = await getWarehouses(cityValue);
//       setWarehouses(
...
//           value={
//             cities.find(option => option.value === formik.values.city) || null
//           }
//           className={`mt-5 ${errorClassInputCity}`}
//         />
//         <ErrorMessage
//           name="city"
//           component="p"
...
//         <div>
//           <Field
//             component={SelectItems} // Передаю name компоненту SelectItems
//             options={options}
//             name="postOfficeApiSelect"
//             errorClassInputSelect={errorClassInputSelect}
//           />
