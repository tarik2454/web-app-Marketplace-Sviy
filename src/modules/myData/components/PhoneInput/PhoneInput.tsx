...
export default function PhoneInput ({ formik, fieldName, id, label, index, field, inputIcon }: Props) {
  ...
  return (
    <div className={`relative h-auto flex flex-col w-full ${styles.customInput}`}>
      ...
      <div className={`flex flex-row-reverse px-4 py-3 gap-2 border-blue-200 border-2 bg-white rounded-default ${borderColor}`}>
        <InputMask mask="+3\80 99 999 99 99"
                   maskChar='_'
